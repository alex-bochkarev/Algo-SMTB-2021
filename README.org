...
**Status:**
- _Russian_ track is over (comments / questions / feedback are still very welcome!)
...
📔 *Notebook:* [[./T4-DataStructures.ipynb][(ipynb)]] [[https://nbviewer.jupyter.org/github/alex-bochkarev/Algo-SMTB-2021/blob/main/T4-DataStructures.ipynb][(nbviewer)]] 
